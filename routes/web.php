...
Route::prefix('user')->middleware(['auth', 'isUser'])->group(function(){
    ...
    Route::get('/process-user-complaint', [UserComplaintController::class, 'allProcessUserComplaints'])->name('user.all.process.complaints');
    Route::get('/pending-user-complaint', [UserComplaintController::class, 'allPendingUserComplaints'])->name('user.all.pending.complaints');
    Route::get('/success-user-complaint', [UserComplaintController::class, 'allDoneUserComplaints'])->name('user.all.success.complaints');
});
